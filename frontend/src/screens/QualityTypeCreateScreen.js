...
export default function QualityTypeCreateScreen() {
    ...
    const submitHandler = async (e)=>{
        ...
        try{
            ...
            toast.success('Qualidade do Produto Criada com Sucesso');
            navigate('/qualitytypeList/');
...
return (
   <Container className='small-container'>
    <Helmet>
        <title>Criar Qualidade do Produto </title>
    </Helmet>
    <h1> Criar Qualidade do Produto</h1>
