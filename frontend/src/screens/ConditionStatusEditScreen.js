...
const reducer = (state, action )=>{
    switch(action.type){
        ...
        case 'FETCH_SUCCESS':
            return {...state, 
                loading: false, conditionStatus: action.payload};
...
export default function ConditionStatusEditScreen() {
    ...
    const submitHandler = async (e)=>{
        ...
        try{
            ...
            toast.success('Estado do produto Actualizado com Sucesso');
...
return (
   <Container className='small-container'>
    <Helmet>
        <title>Editar Estado do Produto </title>
    </Helmet>
    <h1> Editar Estado do Produto</h1>
