...
// Replace the vehicle info section to fix the inputs
const targetStart = `                {/* Informações do Veículo */}`;
...
if (startIndex !== -1 && endIndex !== -1) {
  const replacement = `                {/* Informações do Veículo */}
...
`;
  ...
  console.log('EditProfileScreen.tsx patched successfully');
} else {
