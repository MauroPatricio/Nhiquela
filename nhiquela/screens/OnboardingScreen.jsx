...
const slides = [
  {
    ...
    description: 'Peça entregas, compras de supermercado, medicamentos, mudanças, reboques e muito mais, de forma rápida, segura e sem complicações.',
    icon: 'storefront-outline'
  },
  {
    id: '2',
    title: 'Acompanhe tudo em tempo real.',
    description: 'Veja a localização do seu pedido, acompanhe o motorista ou shopper e receba notificações até à entrega.',
  ...
  {
    id: '4',
    title: 'Bem-vindo à Nhiquela.',
    description: 'Comece agora e descubra uma nova forma de comprar e solicitar serviços em Moçambique.',
...
export default function OnboardingScreen() {
  ...
  const finishOnboarding = async () => {
    try {
      ...
      navigation.replace('BottomNavigation'); // Navigate to main app
    } catch (err) {
