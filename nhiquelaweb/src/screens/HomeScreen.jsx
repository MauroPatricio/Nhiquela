      ...
      <div className="container">
        ...
        <section className="mb-5">
          ...
          <div className="d-flex flex-wrap gap-2 pb-2">
            <button
              className={`btn rounded-pill px-4 py-2 fw-bold text-nowrap transition-all ${selectedCategory === 'ALL'
            ...
            {categories.map((cat) => (
              <button
                key={cat._id}
                className={`btn rounded-pill px-4 py-2 fw-bold text-nowrap d-flex align-items-center gap-2 transition-all ${selectedCategory === cat._id || selectedCategory === cat.name
