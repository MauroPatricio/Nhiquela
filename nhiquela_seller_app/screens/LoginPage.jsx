...
const LoginPage = ({ navigation }) => {
    ...
    const [hideText, setHideText] = useState(true); // Hide password by default
    ...
    const login = async (values) => {
        ...
        try {
            ...
            Alert.alert("Informe o número de telefone ou a senha correta");
        } finally {
            setLoader(false);
        }
    }
            ...
            <SafeAreaView style={{ marginHorizontal: 20 }}>
                <View>
                    ...
                    <Formik
                        ...
                        validateOnChange={false}  // Disable validation on change to avoid unnecessary re-renders
                    >
                            ...
                            <View>
                                ...
                                <View>
                                    <Button
                                        loader={loader}
                                        title="Entrar"
                                        onPress={handleSubmit} // Directly call Formik's handleSubmit
                                        isValid={Object.keys(errors).length === 0 ? '#7F00FF' : 'red'}
                                    />
