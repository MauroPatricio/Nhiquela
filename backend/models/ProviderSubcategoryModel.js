...
const ProviderSubcategorySchema = new Schema({
  ...
  maxNegotiationRounds: { type: Number, default: 3 }, // Maximum negotiation rounds allowed
  ...
  serviceCommission: { type: Number, default: 0 }, // % de comissão aplicada sobre o serviço
