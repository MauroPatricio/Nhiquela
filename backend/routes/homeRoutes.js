...
homeRouter.get(
  ...
  expressAsyncHandler(async (req, res) => {
    ...
    const promos = {
      ...
      searchPlaceholder: 'Pesquisar produtos, servi�os ou motoristas...',
      highlights: [
      ...
      howItWorks: [
        { step: 1, title: 'Escolha', description: 'Selecione um produto ou servi�o entre milhares de op��es.' },
        { step: 2, title: 'Confirme', description: 'Pagamento seguro e confirma��o instant�nea.' },
        { step: 3, title: 'Acompanhe', description: 'Siga em tempo real no mapa interativo.' },
        { step: 4, title: 'Receba', description: 'Entregue no local que indicar, sem complica��o.' },
      ],
      forSuppliers: {
        ...
        points: [
          ...
          'Gest�o simplificada',
          'Relat�rios avan�ados de vendas',
        ],
      },
      forDrivers: {
